...
class Orbita2d:
    ...
    def _update_with(self, new_state: Orbita2DState) -> None:
        ...
        axis1_attr._present_position = new_state.present_position.axis_1
        axis2_attr._present_position = new_state.present_position.axis_2

        axis1_attr._present_speed = new_state.present_speed.axis_1
        axis2_attr._present_speed = new_state.present_speed.axis_2

        axis1_attr._present_load = new_state.present_load.axis_1
        axis2_attr._present_load = new_state.present_load.axis_2

        axis1_attr._goal_position = new_state.goal_position.axis_1
        axis2_attr._goal_position = new_state.goal_position.axis_2

        axis1_attr._speed_limit = new_state.speed_limit.axis_1
        axis2_attr._speed_limit = new_state.speed_limit.axis_2
