...
def test_audit(reachy_sdk_zeroed: ReachySDK) -> None:
    ...
    assert reachy_sdk_zeroed.r_arm.audit == {
        "shoulder": reachy_sdk_zeroed.r_arm.shoulder.audit,
        "elbow": reachy_sdk_zeroed.r_arm.elbow.audit,
        "wrist": reachy_sdk_zeroed.r_arm.wrist.audit,
    }
    assert reachy_sdk_zeroed.l_arm.audit == {
        "shoulder": reachy_sdk_zeroed.l_arm.shoulder.audit,
